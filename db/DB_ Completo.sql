...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-04-2026 a las 18:10:40
...
INSERT INTO `area` (`id_area`, `nombre_area`, `descripcion`, `estado`) VALUES
(1, 'DIRECCION GENERAL', 'Director General del IESP', 1),
(2, 'UNIDAD ADMINISTRATIVA', 'Unidad administrativa del IESP', NULL),
(3, 'UNIDAD ACADEMICA', 'Unidad academica del IESP', 1),
(4, 'UNIDAD DE FORMACION CONTINUA', 'Unidad de formacion continiua del IESP', 1),
(5, 'SECRETARIA ACADEMICA', 'Secretaria academica del IESP', 1),
(6, 'AREA DE CALIDAD', 'Area de calidad de IESP', 1),
(7, 'UNIDAD DE INVESTIGACION', 'Unidad de investigacion del IESP', 1),
(8, 'UNDAD DE BIENESTAR Y EMPLEADBILIDAD', 'Unidad de bienestar y empleabilidad del IESP', 1),
(9, 'AREA USUARIA', 'Area usuaria del IESP alumnos y externos', 1),
(10, 'MESA DE PARTES', 'Mesa de partes del IESP', 1);
...
INSERT INTO `cargo` (`id_cargo`, `cargo`, `estado`, `descripcion`, `id_area`) VALUES
(1, 'DIRECTOR DEL IESP', 1, 'Director general del IESP', 1),
(2, 'SECRETARIA DE DIRECCION', 1, 'Secretaria de la direccion general del IESP', 1),
(3, 'JEFE DE UNIDAD ADMINISTRATIVA', 1, 'Jefe de la unidad administrativa del IESP', 2),
(4, 'JEFE DE UNIDAD ACADEMICA', 1, 'Jefe de unidad academida del IESP', 3),
(5, 'SECRETARIA ACADEMICA', 1, 'Secretaria academica del IESP', 5),
(6, 'ENCARGADO DE MESA DE PARTES', 1, 'Encargado de la mesa de partes del IESP ', 10),
(7, 'JEFE DEL AREA DE CALIDAD', 1, 'Jefe del area de calidad del IESP', 6),
(8, 'COORDINADOR DE ENFERMERIA TECNICA', 1, 'Coordinador del programa de estudios de enfermeria tecnica del IESP', 3),
(9, 'COORDINADOR DE PRODUCCION AGROPECUA', 1, 'Coordinador del programa de estudios de produccion agropecuaria del IESP', 3),
(10, 'JEFE DE LA UNIDAD DE INVESTIGACION', 1, 'Jefe de la unidad de investigacion del IESP', 7),
(11, 'JEFE DE LA UNIDAD DE FORMACION CONT', 1, 'Jefe de la unidad de formacion continua del IESP', 4),
(12, 'PERSONAL DE SEGURIDAD Y VIGILANCIA', 1, 'Personal de seguridad y vigilancia del IESP', 2),
(13, 'PERSONAL DE LIMPIEZA Y MANTENIMIENT', 1, 'Personal de limpieza y mantenimiento del IESP', 2),
(14, 'TESORERIA', 1, 'Tesoreria del IESP', 2),
(15, 'AUXILIAR DE BIBLIOTECA', 1, 'Aulixiar encargado de la biblioteca del IES', 2),
(16, 'ASISTENTE DE PRODUCCION', 1, 'Asistente de produccion del IESP', 2),
(17, 'AUXILIAR DEL LABORATORIO', 1, 'Auxiliar del laboratorio del IESP', 2),
(18, 'DOCENTE', 1, 'Docente del IESP', 3),
(19, 'SERVICIO DE TOPICO', 1, 'Servicio del topico del IESP', 8),
(20, 'SERVICIO DE EMPLEABILIDAD', 1, 'Servicio de empleabilidad del IESP', 8),
(21, 'SERVICIO DE BIENESTAR', 1, 'Servicio del bienestar del IESP', 8),
(22, 'SERVICIO DE PSICOPEDAGOGIA', 1, 'Servicio de psicopedagogia del IESP', 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `detalle_requerimiento_almacen`
--

CREATE TABLE `detalle_requerimiento_almacen` (
  `id_detalle` int(11) NOT NULL,
  `id_requerimiento_almacen` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `detalle_requerimiento_economico`
--

CREATE TABLE `detalle_requerimiento_economico` (
  `id_detalle` int(11) NOT NULL,
  `id_requerimiento_economico` int(11) NOT NULL,
...
CREATE TABLE `documento` (
  ...
  `sumilla` varchar(75) DEFAULT NULL,
  `fundamento_pedido` varchar(256) DEFAULT NULL,
  `codigo_modular` varchar(25) DEFAULT NULL,
  ...
  `estado` enum('borrador','enviado','en_proceso','finalizado','archivado') DEFAULT 'borrador'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `documento_adjuntos`
--
...
CREATE TABLE `documento_adjuntos` (
  ...
  `tipo` enum('pdf','anexo','comprimido') NOT NULL,
  `ruta_archivo` varchar(255) NOT NULL,
  `nombre_original` varchar(150) DEFAULT NULL,
  `extension` varchar(10) DEFAULT NULL,
  `peso` bigint(20) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `documento_archivo`
--
...
CREATE TABLE `documento_archivo` (
  ...
  `ruta_archivo_final` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `documento_derivacion`
--
...
CREATE TABLE `documento_derivacion` (
  ...
  `estado` enum('pendiente','atendido','derivado','finalizado') DEFAULT 'pendiente',
...
CREATE TABLE `documento_historial` (
  ...
  `id_documento` int(11) NOT NULL,
  `id_usuario` int(11) NOT NULL,
  `tipo_evento` enum('creado','enviado','atendido','leido','descargado','derivado','observado','respondido','archivado') NOT NULL,
  `tipo_destino` enum('usuario','area','programa','rol','cargo') DEFAULT NULL,
...
CREATE TABLE `evento` (
  ...
  `descripcion` varchar(255) DEFAULT NULL,
  `nombre_ubicacion` varchar(150) DEFAULT NULL,
  `url_ubicacion` varchar(512) DEFAULT NULL,
...
CREATE TABLE `evento_participante` (
  `id_evento_participante` int(11) NOT NULL,
  `id_evento` int(11) NOT NULL,
  `id_usuario` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `expediente_acceso`
--
...
--
-- Estructura de tabla para la tabla `expediente_historial`
--
...
CREATE TABLE `expediente_historial` (
  ...
  `tipo_evento` enum('creado','modificado','acceso_asignado','acceso_revocado','solicitud_acceso','aprobado','rechazado','archivado') NOT NULL,
  `observacion` text DEFAULT NULL,
  `fecha` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Estructura de tabla para la tabla `expediente_solicitud`
--
...
--
-- Estructura de tabla para la tabla `expediente_version`
--
...
--
-- Estructura de tabla para la tabla `plantilla_acceso`
--
...
CREATE TABLE `programa_estudio` (
  ...
  `programa_estudio` varchar(40) DEFAULT NULL,
...
INSERT INTO `programa_estudio` (`id_programa_estudio`, `programa_estudio`, `descripcion`, `estado`) VALUES
(1, 'ENFERMERIA TECNICA', 'Estudiar Enfermería Técnica en el IESTP Pacarán brinda una oportunidad única para quienes buscan adquirir conocimientos especializados y habilidades prácticas en el apasionante campo de la salud. Con una oferta educativa de calidad, respaldada por profesi', 1),
(2, 'PRODUCCION AGROPECUARIA', 'Estudiar Producción Agropecuaria en el IESTP Pacarán brinda una oportunidad única para quienes buscan adquirir conocimientos especializados y habilidades prácticas en el apasionante campo de la agricultura y la ganadería. Con una oferta educativa de calidad, respaldada por profesionales altamente capacitados y una infraestructura moderna, nuestra institución se destaca como un centro de excelencia para la formación agropecuaria.\r\n\r\nEn primer lugar, el IESTP Pacarán se compromete a ofrecer un cur', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `requerimiento_almacen`
--
...
--
-- Estructura de tabla para la tabla `requerimiento_economico`
--

CREATE TABLE `requerimiento_economico` (
  `id_requerimiento_economico` int(11) NOT NULL,
  `fecha_requerimiento_eco` datetime DEFAULT NULL,
  `motivo` varchar(256) DEFAULT NULL,
  `id_area` int(11) DEFAULT NULL,
  `id_usuario` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 'Usuario', 'Usuario del sistema (alumnos y externos)', 1),
(3, 'Docente', 'Docentes del IES', 1),
(4, 'Administrativo', 'Personal administrativo del IESP', NULL);
...
CREATE TABLE `usuario` (
  ...
  `email_per` varchar(75) DEFAULT NULL,
  `email_ins` varchar(75) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `usuario_programa_estudio`
--

CREATE TABLE `usuario_programa_estudio` (
  `id_usuario_programa` int(11) NOT NULL,
  `id_usuario` int(11) NOT NULL,
  `id_programa_estudio` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `detalle_requerimiento_almacen`
--
ALTER TABLE `detalle_requerimiento_almacen`
  ADD PRIMARY KEY (`id_detalle`),
  ADD KEY `id_requerimiento_almacen` (`id_requerimiento_almacen`),
  ADD KEY `id_producto` (`id_producto`);

--
-- Indices de la tabla `detalle_requerimiento_economico`
--
ALTER TABLE `detalle_requerimiento_economico`
  ADD PRIMARY KEY (`id_detalle`),
  ADD KEY `id_requerimiento_economico` (`id_requerimiento_economico`);
...
ALTER TABLE `documento`
  ...
  ADD UNIQUE KEY `codigo_documento` (`codigo_documento`),
  ADD KEY `id_tipo` (`id_tipo`),
  ADD KEY `id_usuario_emisor` (`id_usuario_emisor`),
  ADD KEY `id_area_origen` (`id_area_origen`);

--
-- Indices de la tabla `documento_adjuntos`
--
...
--
-- Indices de la tabla `documento_archivo`
--
ALTER TABLE `documento_archivo`
  ADD PRIMARY KEY (`id_archivo`),
  ADD KEY `id_documento` (`id_documento`),
  ADD KEY `id_usuario` (`id_usuario`);

--
-- Indices de la tabla `documento_derivacion`
--
ALTER TABLE `documento_derivacion`
  ADD PRIMARY KEY (`id_derivacion`),
  ADD UNIQUE KEY `id_documento` (`id_documento`,`tipo_destino`,`id_destino`),
  ADD KEY `id_usuario_receptor` (`id_usuario_receptor`),
  ADD KEY `idx_doc_derivacion_doc` (`id_documento`),
  ADD KEY `idx_doc_derivacion_destino` (`id_destino`);
...
ALTER TABLE `documento_historial`
  ...
  ADD KEY `idx_doc_historial_doc` (`id_documento`),
  ADD KEY `idx_doc_historial_usuario` (`id_usuario`);
...
ALTER TABLE `evento_participante`
  ADD PRIMARY KEY (`id_evento_participante`),
  ADD UNIQUE KEY `id_evento` (`id_evento`,`id_usuario`),
  ADD KEY `id_usuario` (`id_usuario`),
  ADD KEY `idx_evento_participante_evento` (`id_evento`);
...
--
-- Indices de la tabla `expediente_acceso`
--
ALTER TABLE `expediente_acceso`
  ADD PRIMARY KEY (`id_acceso`),
  ADD UNIQUE KEY `id_expediente` (`id_expediente`,`tipo_acceso`,`id_referencia`),
  ADD KEY `idx_expediente_acceso_exp` (`id_expediente`);

--
-- Indices de la tabla `expediente_documento`
--
ALTER TABLE `expediente_documento`
  ADD PRIMARY KEY (`id_documento`),
  ADD KEY `idx_expediente_doc` (`id_expediente`);

--
-- Indices de la tabla `expediente_historial`
--
ALTER TABLE `expediente_historial`
  ADD PRIMARY KEY (`id_historial`),
  ADD KEY `id_usuario` (`id_usuario`),
  ADD KEY `idx_historial_exp` (`id_expediente`);

--
-- Indices de la tabla `expediente_solicitud`
--
ALTER TABLE `expediente_solicitud`
  ADD PRIMARY KEY (`id_solicitud`),
  ADD KEY `id_usuario_solicitante` (`id_usuario_solicitante`),
  ADD KEY `idx_expediente_solicitud_exp` (`id_expediente`);

--
-- Indices de la tabla `expediente_version`
--
ALTER TABLE `expediente_version`
  ADD PRIMARY KEY (`id_version`),
  ADD UNIQUE KEY `id_documento` (`id_documento`,`version`),
  ADD KEY `id_usuario` (`id_usuario`),
  ADD KEY `idx_version_doc` (`id_documento`);
...
ALTER TABLE `plantilla`
  ...
  ADD KEY `idx_plantilla_usuario` (`id_usuario`);

--
-- Indices de la tabla `plantilla_acceso`
--
ALTER TABLE `plantilla_acceso`
  ADD PRIMARY KEY (`id_acceso`),
  ADD UNIQUE KEY `id_plantilla` (`id_plantilla`,`tipo_acceso`,`id_referencia`),
  ADD KEY `idx_plantilla_acceso` (`id_plantilla`);
...
ALTER TABLE `programa_estudio`
  ADD PRIMARY KEY (`id_programa_estudio`);

--
-- Indices de la tabla `requerimiento_almacen`
--
ALTER TABLE `requerimiento_almacen`
  ADD PRIMARY KEY (`id_requerimiento_almacen`),
  ADD KEY `id_area` (`id_area`),
  ADD KEY `id_usuario` (`id_usuario`);

--
-- Indices de la tabla `requerimiento_economico`
--
ALTER TABLE `requerimiento_economico`
  ADD PRIMARY KEY (`id_requerimiento_economico`),
  ADD KEY `id_area` (`id_area`),
  ADD KEY `id_usuario` (`id_usuario`);
...
--
-- Indices de la tabla `usuario_programa_estudio`
--
ALTER TABLE `usuario_programa_estudio`
  ADD PRIMARY KEY (`id_usuario_programa`),
  ADD KEY `id_usuario` (`id_usuario`),
...
--
-- AUTO_INCREMENT de la tabla `detalle_requerimiento_almacen`
--
ALTER TABLE `detalle_requerimiento_almacen`
  MODIFY `id_detalle` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `detalle_requerimiento_economico`
--
ALTER TABLE `detalle_requerimiento_economico`
  MODIFY `id_detalle` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `documento_adjuntos`
--
ALTER TABLE `documento_adjuntos`
  MODIFY `id_adjunto` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `documento_archivo`
--
ALTER TABLE `documento_archivo`
  MODIFY `id_archivo` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `documento_derivacion`
--
ALTER TABLE `documento_derivacion`
...
--
ALTER TABLE `evento_participante`
  MODIFY `id_evento_participante` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `expediente_acceso`
--
ALTER TABLE `expediente_acceso`
  MODIFY `id_acceso` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `expediente_documento`
--
ALTER TABLE `expediente_documento`
  MODIFY `id_documento` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `expediente_historial`
--
ALTER TABLE `expediente_historial`
  MODIFY `id_historial` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `expediente_solicitud`
--
ALTER TABLE `expediente_solicitud`
  MODIFY `id_solicitud` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `expediente_version`
--
ALTER TABLE `expediente_version`
...
--
-- AUTO_INCREMENT de la tabla `plantilla_acceso`
--
ALTER TABLE `plantilla_acceso`
  MODIFY `id_acceso` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `programa_estudio`
  MODIFY `id_programa_estudio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `requerimiento_almacen`
--
ALTER TABLE `requerimiento_almacen`
  MODIFY `id_requerimiento_almacen` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `requerimiento_economico`
--
ALTER TABLE `requerimiento_economico`
  MODIFY `id_requerimiento_economico` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `usuario_programa_estudio`
--
ALTER TABLE `usuario_programa_estudio`
  MODIFY `id_usuario_programa` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `detalle_requerimiento_almacen`
--
ALTER TABLE `detalle_requerimiento_almacen`
  ADD CONSTRAINT `detalle_requerimiento_almacen_ibfk_1` FOREIGN KEY (`id_requerimiento_almacen`) REFERENCES `requerimiento_almacen` (`id_requerimiento_almacen`),
  ADD CONSTRAINT `detalle_requerimiento_almacen_ibfk_2` FOREIGN KEY (`id_producto`) REFERENCES `producto` (`id_producto`);

--
-- Filtros para la tabla `detalle_requerimiento_economico`
--
ALTER TABLE `detalle_requerimiento_economico`
  ADD CONSTRAINT `detalle_requerimiento_economico_ibfk_1` FOREIGN KEY (`id_requerimiento_economico`) REFERENCES `requerimiento_economico` (`id_requerimiento_economico`);

--
-- Filtros para la tabla `documento`
--
ALTER TABLE `documento`
  ADD CONSTRAINT `documento_ibfk_1` FOREIGN KEY (`id_tipo`) REFERENCES `tipo_documento` (`id_tipo`),
  ADD CONSTRAINT `documento_ibfk_2` FOREIGN KEY (`id_usuario_emisor`) REFERENCES `usuario` (`id_usuario`),
  ADD CONSTRAINT `documento_ibfk_3` FOREIGN KEY (`id_area_origen`) REFERENCES `area` (`id_area`);

--
-- Filtros para la tabla `documento_adjuntos`
--
ALTER TABLE `documento_adjuntos`
  ADD CONSTRAINT `documento_adjuntos_ibfk_1` FOREIGN KEY (`id_documento`) REFERENCES `documento` (`id_documento`);

--
-- Filtros para la tabla `documento_archivo`
--
ALTER TABLE `documento_archivo`
  ADD CONSTRAINT `documento_archivo_ibfk_1` FOREIGN KEY (`id_documento`) REFERENCES `documento` (`id_documento`),
  ADD CONSTRAINT `documento_archivo_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `documento_derivacion`
--
ALTER TABLE `documento_derivacion`
  ADD CONSTRAINT `documento_derivacion_ibfk_1` FOREIGN KEY (`id_documento`) REFERENCES `documento` (`id_documento`),
  ADD CONSTRAINT `documento_derivacion_ibfk_2` FOREIGN KEY (`id_usuario_receptor`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `documento_historial`
--
ALTER TABLE `documento_historial`
  ADD CONSTRAINT `documento_historial_ibfk_1` FOREIGN KEY (`id_documento`) REFERENCES `documento` (`id_documento`),
  ADD CONSTRAINT `documento_historial_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `evento_participante`
--
ALTER TABLE `evento_participante`
  ADD CONSTRAINT `evento_participante_ibfk_1` FOREIGN KEY (`id_evento`) REFERENCES `evento` (`id_evento`),
  ADD CONSTRAINT `evento_participante_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `expediente`
--
ALTER TABLE `expediente`
  ADD CONSTRAINT `expediente_ibfk_1` FOREIGN KEY (`id_usuario_responsable`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `expediente_acceso`
--
ALTER TABLE `expediente_acceso`
  ADD CONSTRAINT `expediente_acceso_ibfk_1` FOREIGN KEY (`id_expediente`) REFERENCES `expediente` (`id_expediente`);

--
-- Filtros para la tabla `expediente_documento`
--
ALTER TABLE `expediente_documento`
  ADD CONSTRAINT `expediente_documento_ibfk_1` FOREIGN KEY (`id_expediente`) REFERENCES `expediente` (`id_expediente`);

--
-- Filtros para la tabla `expediente_historial`
--
ALTER TABLE `expediente_historial`
  ADD CONSTRAINT `expediente_historial_ibfk_1` FOREIGN KEY (`id_expediente`) REFERENCES `expediente` (`id_expediente`),
  ADD CONSTRAINT `expediente_historial_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `expediente_solicitud`
--
ALTER TABLE `expediente_solicitud`
  ADD CONSTRAINT `expediente_solicitud_ibfk_1` FOREIGN KEY (`id_expediente`) REFERENCES `expediente` (`id_expediente`),
  ADD CONSTRAINT `expediente_solicitud_ibfk_2` FOREIGN KEY (`id_usuario_solicitante`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `expediente_version`
--
ALTER TABLE `expediente_version`
  ADD CONSTRAINT `expediente_version_ibfk_1` FOREIGN KEY (`id_documento`) REFERENCES `expediente_documento` (`id_documento`),
  ADD CONSTRAINT `expediente_version_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `plantilla`
--
ALTER TABLE `plantilla`
  ADD CONSTRAINT `plantilla_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `plantilla_acceso`
--
ALTER TABLE `plantilla_acceso`
  ADD CONSTRAINT `plantilla_acceso_ibfk_1` FOREIGN KEY (`id_plantilla`) REFERENCES `plantilla` (`id_plantilla`);

--
-- Filtros para la tabla `requerimiento_almacen`
--
ALTER TABLE `requerimiento_almacen`
  ADD CONSTRAINT `requerimiento_almacen_ibfk_1` FOREIGN KEY (`id_area`) REFERENCES `area` (`id_area`),
  ADD CONSTRAINT `requerimiento_almacen_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `requerimiento_economico`
--
ALTER TABLE `requerimiento_economico`
  ADD CONSTRAINT `requerimiento_economico_ibfk_1` FOREIGN KEY (`id_area`) REFERENCES `area` (`id_area`),
  ADD CONSTRAINT `requerimiento_economico_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `ubigeo_peru_districts`
--
ALTER TABLE `ubigeo_peru_districts`
  ADD CONSTRAINT `ubigeo_peru_districts_ibfk_1` FOREIGN KEY (`province_id`) REFERENCES `ubigeo_peru_provinces` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ubigeo_peru_districts_ibfk_2` FOREIGN KEY (`department_id`) REFERENCES `ubigeo_peru_departments` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `ubigeo_peru_provinces`
--
ALTER TABLE `ubigeo_peru_provinces`
  ADD CONSTRAINT `ubigeo_peru_provinces_ibfk_1` FOREIGN KEY (`department_id`) REFERENCES `ubigeo_peru_departments` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`id_estado`) REFERENCES `estado_usuario` (`id_estado`),
  ADD CONSTRAINT `usuario_ibfk_2` FOREIGN KEY (`id_rol`) REFERENCES `rol` (`id_rol`),
  ADD CONSTRAINT `usuario_ibfk_3` FOREIGN KEY (`id_dep`) REFERENCES `ubigeo_peru_departments` (`id`),
  ADD CONSTRAINT `usuario_ibfk_4` FOREIGN KEY (`id_prov`) REFERENCES `ubigeo_peru_provinces` (`id`),
  ADD CONSTRAINT `usuario_ibfk_5` FOREIGN KEY (`id_dis`) REFERENCES `ubigeo_peru_districts` (`id`);

--
-- Filtros para la tabla `usuario_cargo`
--
ALTER TABLE `usuario_cargo`
  ADD CONSTRAINT `usuario_cargo_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`),
  ADD CONSTRAINT `usuario_cargo_ibfk_2` FOREIGN KEY (`id_cargo`) REFERENCES `cargo` (`id_cargo`);

--
-- Filtros para la tabla `usuario_programa_estudio`
--
ALTER TABLE `usuario_programa_estudio`
  ADD CONSTRAINT `usuario_programa_estudio_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`),
  ADD CONSTRAINT `usuario_programa_estudio_ibfk_2` FOREIGN KEY (`id_programa_estudio`) REFERENCES `programa_estudio` (`id_programa_estudio`);
COMMIT;
